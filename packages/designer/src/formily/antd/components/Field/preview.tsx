...
import {createBehavior, DnFC} from "../../../../core";
import {useComponents, useDesigner} from "../../../../react";
import {useTreeNode} from "../../../../react/hooks/useTreeNode";
...
const isExpression = (val: any) => _.isString(val) && /^\{\{.*\}\}$/.test(val)
