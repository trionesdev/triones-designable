import {isFn, uid} from "../../shared";
import {action, define, observable, toJS} from "@formily/reactive";
import {IDesignerControllerProps, IDesignerLocales, IDesignerProps} from "../types";
import {GlobalRegistry} from "../registry";
import {Operation} from "./Operation";
import {each} from "@formily/shared";
import {
    AppendNodeEvent, CloneNodeEvent, FromNodeEvent,
    InsertAfterEvent,
    InsertBeforeEvent,
    PrependNodeEvent, RemoveNodeEvent, UpdateChildrenEvent,
    UpdateNodePropsEvent,
    WrapNodeEvent
} from "../events";
import {InsertChildrenEvent} from "../events/mutation/InsertChildrenEvent";
